...
namespace AppointmentBot.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        public MainDialog( AppointmentBookingDialog appointmentDialog, ILogger<MainDialog> logger)
        ...
        private static async Task<Boolean> ValidateDoctors(ITurnContext context, CancellationToken cancellationToken)
        {
            //var doctorChoosen = luisResult.Doctor;
            var noDoctor = string.IsNullOrEmpty(null);
